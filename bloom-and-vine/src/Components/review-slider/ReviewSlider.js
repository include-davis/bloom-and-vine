...
// Scroller Settings: Interval (Delay for how long each scroll is in ms)
...
export default function ReviewSlider() {
    ...
    // Logic: Click left or right --> Increment/Decrement curReviewIndex --> Display different review
