      ...
      <div className="Leftside-Screen">
        <div className="contact-wrapper">
          <div className="contact-image">
            <img src={contactImg} alt="null" />
          </div>

          <div className="lets-talk">
            <h1>Let's Talk!</h1>
            <p>
              <b>Phone:</b> 530-312-9139{" "}
            </p>
            <p>
              <b>Email:</b> bloomandvine@gmail.com{" "}
            </p>
            <p>
              <b>Location:</b> Davis, CA{" "}
            </p>
                ...
                <li>
                  <a href="https://facebook.com" target="_blank">
                    <div className="FContact">
                      ...
                      >
                        <path
                          d="M12 1H9C7.67392 1 6.40215 1.52678 5.46447 2.46447C4.52678 3.40215 4 4.67392 4 
                    ...
                    <div className="PContact">
                      ...
                      >
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M7.50211 15.719C8.23021 15.7425 8.88785 16.7055 
								...
								5.24736 12.1725C4.61321 14.9909 2.68727 20.7452 4.04952 23C6.04592 22.0605 7.03237 16.4236 7.50211 15.719Z"
                          fill="black"
                        />
                      </svg>
                    </div>
